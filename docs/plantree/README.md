...
| [[plans/conversation-ux/README.md\|对话交互增强]] | Active | **F0+F1 已落地 2026-08-14**（Run 任务模型：202+订阅流+cancel+编辑重发+断连运行继续+多轮 run_id 隔离，smoke-f0 11/11）；F2-F4/G/H2 待做 | 2026-08-14 F0+F1 goal（commit 78264ea 主体 + 六轮审计修复至 2def45a，e2e 25/0） | F3 ask_user + F4 内联审核（共用卡片组件）；F2 截断重发验证够用否 |
