...
| [[plans/memory-v2/README.md\|记忆系统二期]] | Active（先锋批落地） | **P0/P1/P10 核心已落地（2026-08-14，ADR-016 v2 生效：prompt 3387→1748 字符寒暄轮，知识全走工具）**；P2-P9/P11 Researching | 2026-08-14 先锋批 goal 完成（目录索引+身份行+history_search+P10 语义收紧，e2e 20/0） | 下一批：P9 数据位置 / P11 记忆管线（待裁决） |
