...
> 用户选项交互、前端系统性补课。状态：**Active**（F0+F1 已落地
> 2026-08-14；F2-F4/G/H2 待做）。2026-08-14 用户实测提出，同日扩充
> 架构级发现。
...
- **H2 意图判定可见**：Agent 走分析还是聊天是模型自主判断（灰区），
...
（goal mssz523g，commit 78264ea 主体 + 九轮审计修复链 92e73ca/d80e115/8aa8f65/686e208/8275da4/2def45a/ee56367/9ce0977/87050fa/cdd558f，最终 cdd558f；并发策略裁决=单 Run 拒绝
